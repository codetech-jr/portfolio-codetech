...
// ─── VideoPlayer ───────────────────────────────────────────────────────────
// Isolated client component — the only part that needs useState. Keeping it
// small limits the JS sent to the browser for interactive behavior.
function VideoPlayer({ assets, title }) {
...
function ProjectCard({ project, assets, index }) {
  ...
  return (
    ...
    >
      <VideoPlayer assets={assets} title={project.title} />
